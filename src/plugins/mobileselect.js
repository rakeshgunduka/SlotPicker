 ...
 * Author : onlyhom <https://github.com/onlyhom>
 * Update : rakeshgunduka <https://github.com/rakeshgunduka>
 */

const plugin = (function() {
    require('./mobileselect.css');
    ...
    MobileSelect.prototype = {
        ...
        init: function(config){
            ...
            _this.ensureBtn.addEventListener('click',function(){
                ...
                if (!_this.wheelsData[0].data[_this.curIndexArr[0]].childs.length) {
                    slotID.classList.add('empty');
                    slotID.innerHTML = 'No slots available on this day';
                } else {
                    slotID.classList.remove('empty');
                    slotID.innerHTML = 'Slot ID - ' + _this.wheelsData[0].data[_this.curIndexArr[0]].childs[_this.curIndexArr[1]].childs[_this.curIndexArr[2]].children[0];
                }
        ...
        renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
            ...
            //列
                ...
                if(_this.jsonType){
                    ...
                    //行
                        const className = wheelsData[i].data[j].childs.length ? '': 'strike';
                        tempHTML += '<li class="'+className+'"" data-id="'+wheelsData[i].data[j][_this.keyMap.id]+'">'+wheelsData[i].data[j][_this.keyMap.value]+'</li>';
                    }
                }else{
                    for(var j=0; j<wheelsData[i].data.length; j++){
                    //行
            ...
            //列
                (function (i) {
                    ...
                    if(_this.wheel[i]){
                        ...
                        //行
                            var className;
                            if (_this.wheelsData[i]) {
                                className = _this.wheelsData[i].data[j].childs.length ? '': 'strike';
                            }
                            tempHTML += '<li class="'+className+'" data-id="'+_this.displayJson[i][j][_this.keyMap.id]+'">'+_this.displayJson[i][j][_this.keyMap.value]+'</li>';
                        }
